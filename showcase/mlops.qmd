...
|---|---|---|---|
| **Data** | Has the input shifted? | Four drift monitors: query-embedding distance, retrieval-score PSI, confidence PSI, feedback rate, by language | `mlops/drift.py`, `make drift`, `skein-drift` in MLflow |
