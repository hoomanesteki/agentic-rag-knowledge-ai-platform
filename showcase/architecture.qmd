...
| Brain | LangGraph on langchain-core + a linear pipeline | A bounded agent loop that can re-retrieve, compiled to a langchain-core `Runnable`; or a fast one-pass path |
