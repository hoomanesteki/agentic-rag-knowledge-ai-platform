...
flowchart LR
  ...
  subgraph Analytics [Structured path: DuckDB + dbt]
    direction TB
    BRONZE["bronze<br/>raw, lineage-tracked"] --> SILVER["silver<br/>typed + PII masked"] --> GOLD["gold<br/>curated marts"]
  end
