...
| Brain | Master orchestrator + a linear pipeline (deterministic) | Routes each turn to a lane, then answers through one gated path; `CHAT_BRAIN` selects linear or omni (a former LangGraph agent brain was retired) |
