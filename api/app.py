...
from data.catalog import brand as _brand
from data.catalog import catalog as _catalog
from data.catalog import product as _product
...
class ChatRequest(BaseModel):
    ...
    # true for a spoken (voice) turn, so the reply is kept short and speakable
