...
Built by **Aaron (Hooman) Esteki** as a demonstration of an agentic RAG platform with a knowledge graph. The code, including everything described on this site, is on [GitHub](https://github.com/hoomanesteki/agentic-rag-knowledge-ai-platform). More at [esteki.ca](https://esteki.ca).
:::
