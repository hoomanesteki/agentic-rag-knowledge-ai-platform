...
Every fix ships with a test, and the re-verification pass re-derives the attack against the patched code before the finding is marked closed. That is the standard the whole project holds itself to: findings are documented and defeated, not papered over.
