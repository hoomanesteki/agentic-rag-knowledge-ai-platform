...
_SYSTEM = (
    ...
    "account holder by matching the email or phone they give to the account on file, and check the "
    "name lines up; if they give a name that does not match, or give nothing to identify them, ask "
...
_AGENT_SYSTEM = (
    ...
    "email or phone they give to the account on file and checking the name lines up; if the name "
    "does not match, or they give nothing to identify them, ask once and do not reveal order "
